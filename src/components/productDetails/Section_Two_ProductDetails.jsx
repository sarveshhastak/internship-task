...
const Section_Two_ProductDetails = () => {
    ...
    return <>
        ...
        <div className="row mt-5">
            <div className="col-sm-12 ">
                <div className='w-100 btn-group' style={{ border: "solid", borderRadius: 40, borderColor: "orange" }}>
                    ...
                    <button type="button" class="btn w-100 p-2 rounded-end-5" style={{ backgroundColor: "orange" }}>
                        CUSTOMIZE
                    </button>
                </div>
            </div>
...
export default Section_Two_ProductDetails
