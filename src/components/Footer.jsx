const Footer = () => {
    return <footer className="bg-light pt-5 pb-4" style={{ backgroundColor: "#f4eff4", color: "purple" }}>
        <div className="container text-center ">
            <div className="row text-start">
                ...
                <div className="col-md-4 mb-4">
                    ...
                    <p>General: <a href="mailto:contactus@caratlane.com" className="text-dark text-decoration-none"><strong>contactus@caratlane.com</strong></a></p>
                    <p>Corporate: <a href="mailto:b2b@caratlane.com" className="text-dark text-decoration-none"><strong>b2b@caratlane.com</strong></a></p>
                    <p>HR: <a href="mailto:careers@caratlane.com" className="text-dark text-decoration-none"><strong>careers@caratlane.com</strong></a></p>
                    <p>Grievance: <a className="text-dark text-decoration-none"><strong>click here</strong></a></p>
                </div>
            </div>
