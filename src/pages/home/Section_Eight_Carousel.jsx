        ...
        <div className='container-fluid my-5' style={{ backgroundColor: "#d5c8ff" }}>
            <div className='row align-items-center'>
                <div className="col-md-6 mb-3 mb-md-0">
                    <img className='img-fluid rounded-4' src="https://cdn.caratlane.com/media/static/images/V4/2025/CL/03_MAR/Banner/bestsellers/02/Desktop_1740x850.jpg" alt="" />
                </div>
...
export default Section_Eight_Carousel
